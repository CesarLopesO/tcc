...
from models._transunet.vit_seg_modeling_c4 import VisionTransformer as Net
from models._transunet.vit_seg_modeling_c4 import CONFIGS as CONFIGS_ViT_seg
